package CGI::Office::Contacts::Import::vCards::Controller::Import;
...
use CGI::Office::Contacts::Import::vCards::Util::vCards;
...
sub display
{
	...
	# from CGI::Office::Contacts::Import::vCards::Util::vCards, sub end_element,
	...
	my($importer) = CGI::Office::Contacts::Import::vCards::Util::vCards -> new(callback => \&import_callback, caller => $self, xml => $xml);
...
sub import_callback
{
	...
	# Matches code in CGI::Office::Contacts::Import::vCards::View::Import,
	...
	# When adding a person with CGI::Office::Contacts, there will be a fake
	...
	# CGI::Office::Contacts::Util::Validator is normally called from within one of the
	# controllers based on CGI::Office::Contacts::Controller, with a query object of
	# type CGI::Fast. So, we replace that query object with the one we just fabricated,
	# so CGI::Office::Contacts::Util::Validator will access the 'correct' parameters.
